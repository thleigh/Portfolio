...
import Resume from '../assets/Tanner_Leigh_Resume.pdf'
            ...
            <div className="aboutMain">
                <div className="about">
                    ...
                    <div className="aboutContainer">
                        ...
                        <p className="aboutText"> I am a software engineer and graphic designer with an immeasurable passion for cultivating 
